...
abstract class Gravity_Flow_Step extends stdClass {
	...
	/**
	 * The name of the class containing the log_debug method to be used when writing logging statements.
	 *
	 * @since
	 *
	 * @var string
	 */
	protected $_logger_class = 'Gravity_Flow';
	...
	/**
	 * Logs debug messages to the Gravity Flow or extension log file.
	 *
	 * @since 2.x Added the $var argument.
	 * @since 1.0
	 *
	...
	public function log_debug( $message, $var = null ) {
		if ( ! class_exists( $this->_logger_class ) ) {
			return;
		}
		...
		/** @var GFAddOn $add_on */
		$add_on = call_user_func( array( $this->_logger_class, 'get_instance' ) );
		$add_on->log_debug( $message );
	}
